...
//UOW ID: 8535383
//Assignment 1 Part2 question 6d
...
public class Algorithm2 {
    ...
    private static int[] generateArrayA(int length) {
        int[] arr = new int[length];// Initialize an array for A with specified length
    ...
    public static int[] algorithm2(int[] arrayA, int[] arrayB) {
        customSort(arrayA);
    ...
    public static void main(String[] args) {
        ...
        int[] result = algorithm2(arrayA, arrayB);  // apply algorithm1 to generate result array


        System.out.println("Sorted Array A: " + Arrays.toString(arrayA));
        System.out.println("Unsorted Array B: " + Arrays.toString(arrayB));
