...
public class Assignment_1 {//============================================================================================================
    ...
    private static Set setA = new Set();
...
//---------------------------------------------------------------------------
    ...
    private static void getAnElement() {
        ...
        if (numberType != null) {
            setA.addNumberTypeElement(numberType);
            System.out.println("Element added to the set: " + numberType.getNumber());
            System.out.println("Set contents: " + Arrays.toString(setA.getSetContents())); //Array.toString convert an array to string, more readable for userm and solve issue of the cryptic
            System.out.println("===============");
        } else {
    ...
    private static Set getASet(){
        ...
        // Print and add the random set elements
        System.out.print("A = {");
        setA.printAndAddRandomSet();
        System.out.println(" }");
